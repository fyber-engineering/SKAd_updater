...
struct Options
{
  ...
  const optional<string> plist_path;
  const optional<string> pod_path;
...
{
 private:
  static inline const char* plist_path_Id = "plist_path";
  static inline const char* network_list_Id = "network_list";
  static inline const char* pod_path_Id = "pod_path";
