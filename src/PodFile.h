...
class PodFile
{
 ...
 public:
  /// Parse the podfile in [pod_path], by matching the network name list of [supported_networks].
  explicit PodFile(string pod_path, const vector<string>& supported_networks);
